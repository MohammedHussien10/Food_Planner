...
public class Meals {
    ...
    @SerializedName("strMeasure1") @ColumnInfo(name = "measure1") private String measure1;
    @SerializedName("strMeasure2") @ColumnInfo(name = "measure2") private String measure2;
    @SerializedName("strMeasure3") @ColumnInfo(name = "measure3") private String measure3;
    @SerializedName("strMeasure4") @ColumnInfo(name = "measure4") private String measure4;
    @SerializedName("strMeasure5") @ColumnInfo(name = "measure5") private String measure5;
    @SerializedName("strMeasure6") @ColumnInfo(name = "measure6") private String measure6;
    @SerializedName("strMeasure7") @ColumnInfo(name = "measure7") private String measure7;
    @SerializedName("strMeasure8") @ColumnInfo(name = "measure8") private String measure8;
    @SerializedName("strMeasure9") @ColumnInfo(name = "measure9") private String measure9;
    @SerializedName("strMeasure10") @ColumnInfo(name = "measure10") private String measure10;
    @SerializedName("strMeasure11") @ColumnInfo(name = "measure11") private String measure11;
    @SerializedName("strMeasure12") @ColumnInfo(name = "measure12") private String measure12;
    @SerializedName("strMeasure13") @ColumnInfo(name = "measure13") private String measure13;
    @SerializedName("strMeasure14") @ColumnInfo(name = "measure14") private String measure14;
    @SerializedName("strMeasure15") @ColumnInfo(name = "measure15") private String measure15;
    @SerializedName("strMeasure16") @ColumnInfo(name = "measure16") private String measure16;
    @SerializedName("strMeasure17") @ColumnInfo(name = "measure17") private String measure17;
    @SerializedName("strMeasure18") @ColumnInfo(name = "measure18") private String measure18;
    @SerializedName("strMeasure19") @ColumnInfo(name = "measure19") private String measure19;
    @SerializedName("strMeasure20") @ColumnInfo(name = "measure20") private String measure20;

    public Meals(@NonNull String id, String name, String category, String area, String instructions, String mealImage, String ingredient1, String ingredient2, String ingredient3, String ingredient4, String ingredient5, String ingredient6, String ingredient7, String ingredient8, String ingredient9, String ingredient10, String ingredient11, String ingredient12, String ingredient13, String ingredient14, String ingredient15, String ingredient16, String ingredient17, String ingredient18, String ingredient19, String ingredient20, String measure1, String measure2, String measure3, String measure4, String measure5, String measure6, String measure7, String measure8, String measure9, String measure10, String measure11, String measure12, String measure13, String measure14, String measure15, String measure16, String measure17, String measure18, String measure19, String measure20) {
        this.id = id;
        this.name = name;
    ...
    @Ignore
    public Meals(@NonNull String id, String name, String category, String area, String instructions, String mealImage, String ingredient1, String measure1) {
        this.id = id;
        this.name = name;
        this.category = category;
        this.area = area;
