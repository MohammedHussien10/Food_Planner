...
public class Meals implements Parcelable {
    ...
    public Meals(RemoteMeals remoteMeal){
        this.id = remoteMeal.getId();
        this.name = remoteMeal.getName();
        this.category = remoteMeal.getCategory();
        this.area = remoteMeal.getCategory();
        this.instructions = remoteMeal.getInstructions();
        this.mealImage =  remoteMeal.getMealImage();
        this.youtubeLink =  remoteMeal.getYoutubeLink();
        this.ingredient1 = remoteMeal.getIngredient1();
        this.ingredient2 = remoteMeal.getIngredient2();
        this.ingredient3 = remoteMeal.getIngredient3();
        this.ingredient4 = remoteMeal.getIngredient4();
        this.ingredient5 = remoteMeal.getIngredient5();
        this.ingredient6 = remoteMeal.getIngredient6();
        this.ingredient7 = remoteMeal.getIngredient7();
        this.ingredient8 = remoteMeal.getIngredient8();
        this.ingredient9 = remoteMeal.getIngredient9();
        this.ingredient10 = remoteMeal.getIngredient10();
        this.ingredient11 = remoteMeal.getIngredient11();
        this.ingredient12 = remoteMeal.getIngredient12();
        this.ingredient13 = remoteMeal.getIngredient13();
        this.ingredient14 = remoteMeal.getIngredient14();
        this.ingredient15 = remoteMeal.getIngredient15();
        this.ingredient16 = remoteMeal.getIngredient16();
        this.ingredient17 = remoteMeal.getIngredient17();
        this.ingredient18 = remoteMeal.getIngredient18();
        this.ingredient19 = remoteMeal.getIngredient19();
        this.ingredient20 = remoteMeal.getIngredient20();
        this.measure1 = remoteMeal.getMeasure1();
        this.measure2 = remoteMeal.getMeasure2();
        this.measure3 = remoteMeal.getMeasure3();
        this.measure4 = remoteMeal.getMeasure4();
        this.measure5 = remoteMeal.getMeasure5();
        this.measure6 = remoteMeal.getMeasure6();
        this.measure7 = remoteMeal.getMeasure7();
        this.measure8 = remoteMeal.getMeasure8();
        this.measure9 = remoteMeal.getMeasure9();
        this.measure10 = remoteMeal.getMeasure10();
        this.measure11 = remoteMeal.getMeasure11();
        this.measure12 = remoteMeal.getMeasure12();
        this.measure13 = remoteMeal.getMeasure13();
        this.measure14 = remoteMeal.getMeasure14();
        this.measure15 = remoteMeal.getMeasure15();
        this.measure16 = remoteMeal.getMeasure16();
        this.measure17 = remoteMeal.getMeasure17();
        this.measure18 = remoteMeal.getMeasure18();
        this.measure19 = remoteMeal.getMeasure19();
        this.measure20 = remoteMeal.getMeasure20();
    }
    public Meals(@NonNull String id, String name, String category, String area, String instructions, String mealImage, String youtubeLink, String ingredient1, String ingredient2, String ingredient3, String ingredient4, String ingredient5, String ingredient6, String ingredient7, String ingredient8, String ingredient9, String ingredient10, String ingredient11, String ingredient12, String ingredient13, String ingredient14, String ingredient15, String ingredient16, String ingredient17, String ingredient18, String ingredient19, String ingredient20, String measure1, String measure2, String measure3, String measure4, String measure5, String measure6, String measure7, String measure8, String measure9, String measure10, String measure11, String measure12, String measure13, String measure14, String measure15, String measure16, String measure17, String measure18, String measure19, String measure20) {
        this.id = id;
        this.name = name;
